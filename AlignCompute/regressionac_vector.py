...
class regressionac_vector(aligncompute):
    ...
    def __init__(self,graphset,matcher,distance):
        ...
        # Compute the domain along which we are aligning with respect to
        # the geodesic
    ...
    def align_and_est(self):
        ...
        for k in range(100):
            ...
            # STEP 1: Align wrt the Generalized Geodesic Regression line
    ...
    # Compute the regression with different techiniques
    def est(self):
